...
if(isset($_POST['submitted'])) {
	...
	if(trim($_POST['checking']) !== '') {
		...
		if(!isset($hasError)) {
			...
			$emailTo = 'contact@idweb-agence.com';
	...
	<?php while (have_posts()) : the_post(); ?>
		...
		<form action="<?php the_permalink(); ?>" id="contactForm" method="post">
			...
			<ol class="forms">
                ...
                <li><label for="contactPrenom">Prénom</label>
					<input type="text" name="contactPrenom" id="contactPrenom" value="<?php if(isset($_POST['contactPrenom'])) echo $_POST['contactPrenom'];?>" class="requiredField" />
					<?php if($nameError != '') { ?>
                ...
                <li><label for="contactPhone">Téléphone</label>
					<input type="text" name="contactPhone" id="contactPhone" value="<?php if(isset($_POST['contactPhone'])) echo $_POST['contactPhone'];?>" class="requiredField" />
					<?php if($nameError != '') { ?>
						<span class="error"><?=$prenomError;?></span> 
					<?php } ?>
				</li>
